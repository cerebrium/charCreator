...
class Classes extends React.Component{
    ...
    render() {
        const mappedClasses = this.props.charClasses.map((ele, id) => <button type='text' key={id} id={ele._id} classdeets={}onClick={this.handleOnClick}>Select Class {ele.name}</button>)
        return (
            <Router>
                <>
